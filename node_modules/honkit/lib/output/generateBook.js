...
function processOutput(generator, output) {
    return Promise(output)
        ...
        .then(preparePages)
        .then(prepareAssets)
        .then(callHook.bind(null, "config", (output) => {
        ...
        .then(callHook.bind(null, "init", (output) => {
        return {};
    }, (output) => {
        return output;
    }))
        ...
        .then(callHook.bind(null, "finish:before", (output) => {
        return {};
    }, (output) => {
        return output;
    }))
        ...
        .then(callHook.bind(null, "finish", (output) => {
        return {};
    }, (output) => {
        return output;
    }));
